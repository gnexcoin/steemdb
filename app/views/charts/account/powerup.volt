<script>
  d3.json("/api/account/{{ account.name }}/powerup").get(function(error, rows) {
    var data = rows;
    ...
    var yLabelValue = new Plottable.Components.AxisLabel("GNEX", "90");
    ...
    table.renderTo("svg#account-powerup");
  });
</script>
